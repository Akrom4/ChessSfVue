 ...
 */
class getUserCoursesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserCoursesRepository' shared autowired service.
     *
     * @return \App\Repository\UserCoursesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserCoursesRepository.php';

        return $container->privates['App\\Repository\\UserCoursesRepository'] = new \App\Repository\UserCoursesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
